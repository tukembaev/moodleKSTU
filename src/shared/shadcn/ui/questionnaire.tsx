...
function QuestionnaireItem({
  ...
  return (
    <QuestionnairePrimitive.Item
      ...
      className={cn("min-w-0 border-0 p-0 outline-none flex flex-col gap-4", className)}
      {...props}
    />
  );
}
...
function QuestionnaireChoice({
  ...
  return (
    <QuestionnairePrimitive.Choice
      ...
      className={cn(
        "group/questionnaire-choice relative flex min-h-11 cursor-pointer items-start gap-2.5 rounded-lg border border-input bg-transparent px-3 py-2.5 text-start text-sm outline-none select-none transition-colors",
    ...
    >
      ...
      <span
        ...
        className="pointer-events-none relative flex size-4 shrink-0 translate-y-0.5 items-center justify-center rounded-[4px] border border-input dark:bg-input/30 group-data-[type=radio]/questionnaire-choice:rounded-full group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-checked/questionnaire-choice:border-primary group-data-checked/questionnaire-choice:bg-primary group-data-checked/questionnaire-choice:text-primary-foreground dark:group-data-checked/questionnaire-choice:bg-primary"
      >
        <span
  ...
  return (
    ...
    >
      <QuestionnairePrimitive.Input
        ...
        className={cn(
          "h-8 min-h-11 w-full min-w-0 rounded-lg border border-input bg-transparent px-2.5 py-1 text-base outline-none transition-[color,box-shadow,background-color] sm:min-h-0 md:text-sm",
          "selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground dark:bg-input/30",
