        ...
        <div className="mx-auto mt-2 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {isLoading ? (
            ...
            <FadeInList>
                  ...
                  <Card key={bank.id} className="transition-all duration-300">
                    <CardContent className="flex flex-col gap-2 p-4">
                      ...
                      <span className="line-clamp-2 text-md text-foreground/80">
                        {bank.description || t("Без описания")}
                      </span>
                      <div className="mt-2 flex flex-col gap-2 sm:flex-row">
                        ...
                        <UseConfirmationDialog
                          title={t("Удалить Коллекция?")}
                          description={t("«{{name}}» будет удалён вместе со всеми вопросами.", {
                            name: bank.name,
                          })}
              ...
              >
                <UseTooltip text={t("Создать Коллекция вопросов")}>
                  <div className="flex flex-col items-center justify-center gap-3">
                    ...
                    <div className="text-center">
                      <p className="text-lg font-medium text-foreground transition-colors group-hover:text-primary">
                        {t("Добавить Коллекцию")}
                      </p>
                      <p className="mt-1 text-sm text-muted-foreground">
                        {t("Нажмите, чтобы добавить коллекцию вопросов")}
                      </p>
                    </div>
                  </div>
                </UseTooltip>
