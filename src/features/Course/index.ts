...
import { CreateCoursePayload, CreateFAQPayload, CreateThemePayload ,EditThemePayload, editPermissionPayload ,UploadMaterialPayload ,UploadAnswerPayload , FinishCoursePayload,FinishCourseFormPayload,ExtraPointPayload, BindCourseStreamsPayload, CourseStreamItemPayload} from "./model/types/course_payload";
...
export type { CreateCoursePayload, CreateFAQPayload, CreateThemePayload, EditThemePayload, editPermissionPayload ,UploadMaterialPayload ,UploadAnswerPayload ,FinishCoursePayload,FinishCourseFormPayload,ExtraPointPayload, BindCourseStreamsPayload, CourseStreamItemPayload};
